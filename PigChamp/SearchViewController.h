...
@property (weak, nonatomic) IBOutlet UIButton *btnSemenBatch;
@property (weak, nonatomic) IBOutlet UILabel *lblSemenBatch;
@property (weak, nonatomic) IBOutlet UILabel *lblBoarGroup;
@property (weak, nonatomic) IBOutlet UIButton *btnBoarGroup;
