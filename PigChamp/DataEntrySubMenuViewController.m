                ...
                for (int i=0; i<9; i++) {
                    if (i==0) {
                        ...
                        if ([dictMenu objectForKey:[@"Fostering" uppercaseString]] && ![[dictMenu objectForKey:[@"Fostering" uppercaseString]] isKindOfClass:[NSNull class]]) {
                            [self addObject:[dictMenu objectForKey:[@"Fostering" uppercaseString]]?[dictMenu objectForKey:[@"Fostering" uppercaseString]]:@""englishVersion:@"Fostering"];
                        }
                        else{
                            [arrMenu addObject:@"Fostering"];
                        }
...
//            [arrMenu addObject:@"Batch Movement"];
//            [arrMenu addObject:@"Batch Movement by Location"];
...
//                    else  if (i==5){
//                        if ([dictMenu objectForKey:[@"Batch Movement" uppercaseString]] && ![[dictMenu objectForKey:[@"Batch Movement" uppercaseString]] isKindOfClass:[NSNull class]]) {
//                            [self addObject:[dictMenu objectForKey:[@"Batch Movement" uppercaseString]]?[dictMenu objectForKey:[@"Batch Movement" uppercaseString]]:@"" englishVersion:@"Batch Movement"];
//                        }
//                        else{
//                            [arrMenu addObject:@"Batch Movement"];
//                        }
//                    }else  if (i==6){
//                        if ([dictMenu objectForKey:[@"Batch Movement by Location" uppercaseString]] && ![[dictMenu objectForKey:[@"Batch Movement by Location" uppercaseString]] isKindOfClass:[NSNull class]]) {
//                            [self addObject:[dictMenu objectForKey:[@"Batch Movement by Location" uppercaseString]]?[dictMenu objectForKey:[@"Batch Movement by Location" uppercaseString]]:@"" englishVersion:@"Batch Movement by Location"];
//                        }
//                        else{
//                            [arrMenu addObject:@"Batch Movement by Location"];
//                        }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    @try {
        ...
        if ([[arrEventCode objectAtIndex:indexPath.row] isEqualToString:@"27"])
        {
            NSString *savedValue = [[NSUserDefaults standardUserDefaults]
                                    stringForKey:@"user_para_fostering_value"];
            
            if ([savedValue isEqualToString:@"0"])
            {
                newView.strEventCode = @"93";
            }
            if([savedValue isEqualToString:@"1"])
            {
                newView.strEventCode = @"27";
            }
        }
        //******Code Change By Priyanka on 11th May 2018********//
