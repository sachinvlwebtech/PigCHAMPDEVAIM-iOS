...
- (void)viewDidLoad {
    @try {
        ...
        arrReportsMenu = [[NSMutableArray alloc]initWithObjects:@"Herd Summary",@"Animal Status",@"Sow Details",@"Active Animals List",@"Sows Due for Attention",@"Open Sow List",@"Gilt Pool",@"Sows Due to Farrow",@"Warning List-Not Served",@"Warning List-Not Weaned",@"Reports",@"Your session has been expired. Please login again.",@"Server Error.",@"OK", nil];
