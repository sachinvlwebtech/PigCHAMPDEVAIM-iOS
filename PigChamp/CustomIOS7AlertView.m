...
- (void)showLoadingView
{
    ...
    {
        [self show];
        vwActivityIndicatorObj = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
        vwActivityIndicatorObj.frame =  CGRectMake(dialogContainer.frame.size.width/2 - 30,20, 60,60);
        vwActivityIndicatorObj.color = [UIColor blackColor];
        [vwActivityIndicatorObj startAnimating];
        [dialogContainer addSubview:vwActivityIndicatorObj];
        
        btnClose = [UIButton buttonWithType:UIButtonTypeCustom];
        btnClose.frame = CGRectMake(260, 5, 35, 35);
        [btnClose setImage:[UIImage imageNamed:@"CloseCross"] forState:UIControlStateNormal];
       // [btnClose addTarget:self action:@selector(cancelRequestAndHide) forControlEvents:UIControlEventTouchUpInside];
        [dialogContainer addSubview:btnClose];
        
        UILabel *lbl = [[UILabel alloc] initWithFrame:CGRectMake(30, 65, 250, 50)];
        lbl.backgroundColor = [UIColor clearColor];
        lbl.textAlignment = NSTextAlignmentCenter;
        lbl.textColor = [UIColor blackColor];
        lbl.font = [UIFont systemFontOfSize:19];
        lbl.text = @"Loading...";
        [dialogContainer addSubview:lbl];
...
//        [dialogContainer addSubview:btnClose];
        ...
        UILabel *lblTitle = [[UILabel alloc] initWithFrame:CGRectMake(25, 15, 250, 20)];
        lblTitle.backgroundColor = [UIColor clearColor];
        lblTitle.textAlignment = NSTextAlignmentCenter;
        lblTitle.textColor = [UIColor blackColor];
        lblTitle.font = [UIFont boldSystemFontOfSize:19];
        lblTitle.text = title;
        [dialogContainer addSubview:lblTitle];
        
        UILabel *lbl = [[UILabel alloc] initWithFrame:CGRectMake(30, 30, 250, 50)];
        lbl.backgroundColor = [UIColor clearColor];
        lbl.textAlignment = NSTextAlignmentCenter;
        lbl.textColor = [UIColor blackColor];
        lbl.font = [UIFont systemFontOfSize:19];
        ...
        vwActivityIndicatorObj = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleWhiteLarge];
        vwActivityIndicatorObj.frame =  CGRectMake(dialogContainer.frame.size.width/2 - 30,70, 60,60);
        vwActivityIndicatorObj.color = [UIColor blackColor];
        [vwActivityIndicatorObj startAnimating];
        [dialogContainer addSubview:vwActivityIndicatorObj];
...
- (void)showCustomwithView:(UIView *)vw title:(NSString*)title {
    ...
    UILabel *lblTitle = [[UILabel alloc] initWithFrame:CGRectMake(25, 12, 250, 20)];
    lblTitle.backgroundColor = [UIColor clearColor];
    lblTitle.textAlignment = NSTextAlignmentCenter;
    lblTitle.textColor = [UIColor blackColor];
