...
- (void)viewWillAppear:(BOOL)animated{
 ...
 //   self.lblCopyright.text = @"Copyright © PigCHAMP 2017";
    ...
    self.lblCopyright.text = [NSString stringWithFormat:@"Copyright © PigCHAMP %ld",(long)year];
...
//    NSLog(@"strSelectedDate=%@",strSelectedDate);
    ...
    NSArray* resultArray1 = [[CoreDataHandler sharedHandler] getTranslatedText:[[NSMutableArray alloc] initWithObjects:@"About",@"iOS Mobile Application Software",@"Version 2.0",@"Copyright © pigCHAMP 2021",@"OK",@"Your session has been expired. Please login again.",@"Server Error.",nil]];
    ...
    if (resultArray1.count!=0){
        ...
        for (int i=0; i<7; i++) {
            if (i==0) {
                ...
                if ([dictMenu objectForKey:[@"Vesrion 2.0" uppercaseString]] && ![[dictMenu objectForKey:[@"Vesrion 2.0" uppercaseString]] isKindOfClass:[NSNull class]]) {
                    if ([[dictMenu objectForKey:[@"Vesrion 2.0" uppercaseString]] length]>0) {
                        self.lblVersion.text = [dictMenu objectForKey:[@"Vesrion 2.0" uppercaseString]]?[dictMenu objectForKey:[@"Vesrion 2.0" uppercaseString]]:@"";
                    }
                }
            }else if (i==3) {
                if ([dictMenu objectForKey:[@"Copyright © PigCHAMP 2021" uppercaseString]] && ![[dictMenu objectForKey:[@"Copyright © PigCHAMP 2021" uppercaseString]] isKindOfClass:[NSNull class]]) {
                    if ([[dictMenu objectForKey:[@"Copyright © PigCHAMP 2021" uppercaseString]] length]>0) {
                        self.lblCopyright.text = [dictMenu objectForKey:[@"Copyright © PigCHAMP 2021" uppercaseString]]?[dictMenu objectForKey:[@"Copyright © PigCHAMP 2021" uppercaseString]]:@"";
                    }
                }
            }else if (i==4) {
