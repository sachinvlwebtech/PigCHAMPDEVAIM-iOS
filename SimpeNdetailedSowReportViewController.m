...
//        [tracker send:[[GAIDictionaryBuilder createScreenView] build]];
        ...
        self.title = @"Sow Details";
        {
            ...
            strCurrent = @"Current";
            strLastParity = @"Last Parity";
            strLifetime = @"Life Time";
            strFemaleIdentityMsg = @"Female Identity does not exists.";
            NSArray* resultArray1 = [[CoreDataHandler sharedHandler] getTranslatedText:[[NSMutableArray alloc] initWithObjects:@"OK",@"Please Wait...",@"You must be online for the app to function.",@"Sow Details",@"Your session has been expired. Please login again.",@"Server Error.",@"Signing off.",@"Simple",@"Detailed",@"Current",@"Last Parity",@"Life Time",@"Female Identity does not exists.",nil]];
            ...
            if (resultArray1.count!=0){
                ...
                for (int i=0; i<13; i++) {
                    if (i==0){
                        ...
                        if ([dictMenu objectForKey:[@"Current" uppercaseString]] && ![[dictMenu objectForKey:[@"Current" uppercaseString]] isKindOfClass:[NSNull class]]) {
                            if ([[dictMenu objectForKey:[@"Current" uppercaseString]] length]>0) {
                                strCurrent = [dictMenu objectForKey:[@"Current" uppercaseString]]?[dictMenu objectForKey:[@"Current" uppercaseString]]:@"";
                            }
                        }
                    }else  if (i==10){
                        if ([dictMenu objectForKey:[@"Last Parity" uppercaseString]] && ![[dictMenu objectForKey:[@"Last Parity" uppercaseString]] isKindOfClass:[NSNull class]]) {
                            if ([[dictMenu objectForKey:[@"Last Parity" uppercaseString]] length]>0) {
                                strLastParity = [dictMenu objectForKey:[@"Last Parity" uppercaseString]]?[dictMenu objectForKey:[@"Last Parity" uppercaseString]]:@"";
                            }
                        }
                    }else  if (i==11){
                        if ([dictMenu objectForKey:[@"Life Time" uppercaseString]] && ![[dictMenu objectForKey:[@"Life Time" uppercaseString]] isKindOfClass:[NSNull class]]) {
                            if ([[dictMenu objectForKey:[@"Life Time" uppercaseString]] length]>0) {
                                strLifetime = [dictMenu objectForKey:[@"Life Time" uppercaseString]]?[dictMenu objectForKey:[@"Life Time" uppercaseString]]:@"";
                            }
                        }
                    }else  if (i==12){
                        if ([dictMenu objectForKey:[@"Female Identity does not exists." uppercaseString]] && ![[dictMenu objectForKey:[@"Female Identity does not exists." uppercaseString]] isKindOfClass:[NSNull class]]) {
                            if ([[dictMenu objectForKey:[@"Female Identity does not exists." uppercaseString]] length]>0) {
                                strFemaleIdentityMsg = [dictMenu objectForKey:[@"Female Identity does not exists." uppercaseString]]?[dictMenu objectForKey:[@"Female Identity does not exists." uppercaseString]]:@"";
                            }
                        }
                    }
                }
        ...
        [self.btnSimple setTitle:strSimple forState:UIControlStateNormal];
        [self.btnDetailed setTitle:strDetailed forState:UIControlStateNormal];
    ...
    @try {
        ...
        if (![[[arrSimpleNdetailed objectAtIndex:indexPath.row] valueForKey:@"prop"] isKindOfClass:[NSNull class]]){
           // lblName.text = [[arrSimpleNdetailed objectAtIndex:indexPath.row] valueForKey:@"prop"]?[[arrSimpleNdetailed objectAtIndex:indexPath.row] valueForKey:@"prop"]:@"";
            lblName.text = [[arrSimpleNdetailed objectAtIndex:indexPath.row] valueForKey:@"translatedValue"]?[[arrSimpleNdetailed objectAtIndex:indexPath.row] valueForKey:@"translatedValue"]:@"";
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)cv cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section==0){
        ...
        if (indexPath.row==0) {
            ...
            cellobj.lblHeader.text = strCurrent;
        }
        else if (indexPath.row==2) {
            cellobj.lblHeader.text = strLastParity;
        }
        else if (indexPath.row==3) {
            cellobj.lblHeader.text = strLifetime;
        }
...
//            }
            if (indexPath.row==0)
            {
                if (![[dict valueForKey:@"translatedValue"] isKindOfClass:[NSNull class]])
                {
                    if ([[dict valueForKey:@"translatedValue"] length]>0) {
                        cell.lblcontent.text = [dict valueForKey:@"translatedValue"]?[dict valueForKey:@"translatedValue"]:@"";
                    }else {
                        cell.lblcontent.text = @"";
                    }
                }else {
